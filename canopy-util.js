...
var fs = require('fs');
var sslCas = require('ssl-root-cas/latest');
sslCas.inject().addFile('./ssl/GandiStandardSSLCA2.pem');

var req = function(params){

/*
    params (all json w/auth): host, port, https(boolean) 
                             path, un, pw, 
...
*/
    ...
    var options = {
        ...
        rejectUnauthorized: !params.skipSSLCheck
    }
